...
import edu.tdt.entity.MobileStoreSystemBean;
import edu.tdt.entity.MobileStoreSystemBeanRemote;
...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>TDT Chain Store System Management</h1>");
            //Initialize JNDI
            readJNDI();
            
            //Lookup the StoreManagementSystem
            ...
            if(action.equals("LogIn"))
            {
                ...
                User current_user = session.Login(username, password);
